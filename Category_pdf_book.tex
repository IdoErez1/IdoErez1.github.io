...
\end{remark}
\begin{proposition}[הפעלה של פונקטור משמאל על העתקה טבעית]
...
\end{proposition}
\begin{definition}[מרכז של קטגוריה]
...
\end{example}
\begin{example}[מרכזים נוספים של קטגוריות]
...
\begin{definition}[ביפונקטור Hom]
